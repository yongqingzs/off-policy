...
# python train_mpe.py --env_name "MPE" --algorithm_name "maddpg" --experiment_name "debug" --scenario_name "simple_spread" --num_agents 3 --num_landmarks 3 --seed 1 --n_rollout_threads 1 --episode_length 25 --actor_train_interval_step 1 --tau 0.005 --lr 7e-4 --num_env_steps 2000 --batch_size 1000 --buffer_size 500000 --use_wandb False
